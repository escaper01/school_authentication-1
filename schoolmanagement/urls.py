...
urlpatterns = [
    ...
    #admin
    path('adminlogin', views.custom_admin_login,name='adminlogin'),
    path('adminsignup', views.admin_signup_view, name='adminsignup'),
    #student
    path('studentsignup', views.student_signup_view,name='studentsignup'),
    path('studentlogin', views.custom_student_login, name='studentlogin'),
    #teacher
    path('teachersignup', views.teacher_signup_view,name='teachersignup'),
    path('teacherlogin', views.custom_teacher_login, name='teacherlogin'),
